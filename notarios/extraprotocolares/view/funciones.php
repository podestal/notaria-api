...
function RAYAFIRMAS($conteo) {
	$result=0;$concatenador="";
	if($conteo>30){
		$conteo=="30";
	}else{
		$conteo==$conteo;
	...
	for($result=1;$result<=$conteo+5;$result++){
		$concatenador.="_";
	}   
    return $concatenador; 
}
function fNegrita($cadena){
	// formato negrita #-
	$formatNegrita="#-";
return $formatNegrita.$cadena.$formatNegrita;
}

function NEGRITA($cadena,$caracter) {
